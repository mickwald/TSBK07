...
GLfloat myMatrix[] = {  1.0f, 0.0f, 0.0f, 0.2f,
...
void init(void)
{
	...
	glVertexAttribPointer(glGetAttribLocation(program, "in_Position"), 3, GL_FLOAT, GL_FALSE, 0, 0); //Get out_color from program and change it here ~
...
void onTimer(int value)
{
	...
	t = (GLfloat)glutGet(GLUT_ELAPSED_TIME) * 2* M_PI / 1000;
	//doTransformTick(t);
	glUniformMatrix4fv(glGetUniformLocation(program, "myMatrix"), 1, GL_TRUE, myMatrix);
	glutPostRedisplay();	
